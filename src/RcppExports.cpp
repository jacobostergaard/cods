...
RcppExport SEXP cods_bootstrapCpp(SEXP XSEXP, SEXP BSEXP, SEXP dtSEXP) {
BEGIN_RCPP
...
RcppExport SEXP cods_bootstrapCppOld(SEXP XSEXP, SEXP BSEXP, SEXP dtSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type X(XSEXP);
...
RcppExport SEXP cods_exactSimulation(SEXP NSEXP, SEXP dtSEXP, SEXP z0SEXP, SEXP freqSEXP, SEXP lvlSEXP, SEXP s_phiSEXP, SEXP s_gamSEXP, SEXP modelSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP cods_factorialCpp(SEXP xSEXP, SEXP resultSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP cods_kronSum(SEXP ASEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP cods_matPow(SEXP ASEXP, SEXP kSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type A(ASEXP);
...
RcppExport SEXP cods_integralApprox(SEXP PSEXP, SEXP tSEXP, SEXP verboseSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP cods_Omega(SEXP PSEXP, SEXP tSEXP, SEXP sSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type P(PSEXP);
...
RcppExport SEXP cods_johansenCpp(SEXP XSEXP, SEXP rSEXP, SEXP ASEXP, SEXP BSEXP, SEXP dtSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type X(XSEXP);
...
RcppExport SEXP cods_oscillator(SEXP NSEXP, SEXP dtSEXP, SEXP z0SEXP, SEXP alphaSEXP, SEXP betaSEXP, SEXP omegaSEXP, SEXP freqSEXP, SEXP lvlSEXP, SEXP S_phiSEXP, SEXP S_gamSEXP, SEXP modelSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< int >::type N(NSEXP);
...
RcppExport SEXP cods_rcpparma_hello_world() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP cods_rcpparma_outerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP cods_rcpparma_innerproduct(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::colvec& >::type x(xSEXP);
...
RcppExport SEXP cods_rcpparma_bothproducts(SEXP xSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::colvec& >::type x(xSEXP);
...
RcppExport SEXP cods_testCpp(SEXP ASEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type A(ASEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"cods_bootstrapCpp", (DL_FUNC) &cods_bootstrapCpp, 3},
    {"cods_bootstrapCppOld", (DL_FUNC) &cods_bootstrapCppOld, 3},
    {"cods_exactSimulation", (DL_FUNC) &cods_exactSimulation, 8},
    {"cods_factorialCpp", (DL_FUNC) &cods_factorialCpp, 2},
    {"cods_kronSum", (DL_FUNC) &cods_kronSum, 1},
    {"cods_matPow", (DL_FUNC) &cods_matPow, 2},
    {"cods_integralApprox", (DL_FUNC) &cods_integralApprox, 3},
    {"cods_Omega", (DL_FUNC) &cods_Omega, 3},
    {"cods_johansenCpp", (DL_FUNC) &cods_johansenCpp, 5},
    {"cods_oscillator", (DL_FUNC) &cods_oscillator, 11},
    {"cods_rcpparma_hello_world", (DL_FUNC) &cods_rcpparma_hello_world, 0},
    {"cods_rcpparma_outerproduct", (DL_FUNC) &cods_rcpparma_outerproduct, 1},
    {"cods_rcpparma_innerproduct", (DL_FUNC) &cods_rcpparma_innerproduct, 1},
    {"cods_rcpparma_bothproducts", (DL_FUNC) &cods_rcpparma_bothproducts, 1},
    {"cods_testCpp", (DL_FUNC) &cods_testCpp, 1},
    {NULL, NULL, 0}
};
